...
The app uses the local model at `assets/Ring N080111.glb` for the hero viewer and as fallback after morph. More sample models: https://github.com/KhronosGroup/glTF-Sample-Models
